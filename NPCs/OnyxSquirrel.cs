...
{
    public class OnyxSquirrel : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.friendly = false;
            NPC.catchItem = ModContent.ItemType<Items.OnyxSquirrel>();
        }
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("OnyxSquirrelGore").Type);
        }
    }
}