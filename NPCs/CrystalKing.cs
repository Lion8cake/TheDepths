    ...
    public class CrystalKing : ModNPC
    {
        ...
        public override void AI()
        {
			...
			if (NPC.ai[2] != 0f && NPC.ai[3] != 0f)
			{
				...
				for (int num1274 = 0; num1274 < 50; num1274++)
				{
					...
					int num1285 = Dust.NewDust(val6, num1612, num1613, DustID.Frost, 0f, 0f, 100, default, Main.rand.Next(1, 3));
				...
				for (int num1373 = 0; num1373 < 50; num1373++)
				{
					...
					int num1385 = Dust.NewDust(val14, num1628, num1629, DustID.Frost, 0f, 0f, 100, default, Main.rand.Next(1, 3));
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                Gore.NewGore(entitySource, NPC.position, new Vector2(Main.rand.Next(-6, 7), Main.rand.Next(-6, 7)), Mod.Find<ModGore>("CrystalKingGore1").Type);
                Gore.NewGore(entitySource, NPC.position, new Vector2(Main.rand.Next(-6, 7), Main.rand.Next(-6, 7)), Mod.Find<ModGore>("CrystalKingGore2").Type);
                Gore.NewGore(entitySource, NPC.position, new Vector2(Main.rand.Next(-6, 7), Main.rand.Next(-6, 7)), Mod.Find<ModGore>("CrystalKingGore2").Type);
            }
        }
    }
