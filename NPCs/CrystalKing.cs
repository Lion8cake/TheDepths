        ...
        public override void AI()
        {
            ...
            if (!player.dead && Vector2.Distance(player.Center, NPC.Center) < 1000f)
            {
                ...
                if (NPC.ai[1] >= 180f)
                {
                    ...
                    //Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), NPC.Center.X + (23f * NPC.direction), NPC.Center.Y - 40f, 0f, -10f, ProjectileType<CrystalBall>(), damage, 3f, Main.myPlayer);
                    attacking = false;
                    NPC.ai[1] = 0f;
                }
            }
