...
namespace TheDepths
{
	public class TheDepthsRecipes : ModSystem
	{
		public override void AddRecipes()
		{
			...
			QuicksilverBomb.AddCondition(Language.GetOrRegister("Mods.TheDepths.Recipes.NearQuicksilver"), Condition.NearLiquid(ModContent.LiquidType<Quicksilver>()).Predicate);
			...
			QuicksilverRocket.AddCondition(Language.GetOrRegister("Mods.TheDepths.Recipes.NearQuicksilver"), Condition.NearLiquid(ModContent.LiquidType<Quicksilver>()).Predicate);
			...
			MagicQuicksilverDropper.AddCondition(Language.GetOrRegister("Mods.TheDepths.Recipes.NearQuicksilver"), Condition.NearLiquid(ModContent.LiquidType<Quicksilver>()).Predicate);
			...
			SilverfallBlock.AddCondition(Language.GetOrRegister("Mods.TheDepths.Recipes.NearQuicksilver"), Condition.NearLiquid(ModContent.LiquidType<Quicksilver>()).Predicate);
