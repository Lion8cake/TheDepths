...
namespace TheDepths.Projectiles
{
    public class WhiteLightningOrb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<WhiteLightningOrb2>()] > 0 && player.ownedProjectileCounts[ModContent.ProjectileType<WhiteLightningTo2>()] <= 8)
            {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<WhiteLightningOrb3>()] > 0 && player.ownedProjectileCounts[ModContent.ProjectileType<WhiteLightningTo3>()] <= 8)
            {
    ...
    public class WhiteLightningOrb2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Player player = Main.player[Projectile.owner];
            if (player.ownedProjectileCounts[ModContent.ProjectileType<WhiteLightningOrb>()] > 0 && player.ownedProjectileCounts[ModContent.ProjectileType<WhiteLightningTo1>()] <= 8)
            {
