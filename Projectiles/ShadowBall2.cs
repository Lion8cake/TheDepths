		...
		public override void AI()
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			if (choice == 0)
			{
				...
				Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, ModContent.ProjectileType<ShadowBall3>(), Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
			}
