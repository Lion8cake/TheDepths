...
namespace TheDepths.Projectiles
{
		...
		public override void Kill(int timeLeft)
	{
		...
		if (choice == 0)
		{
			Projectile.NewProjectile(new EntitySource_Misc(""), Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ModContent.ProjectileType<ShadowBall3>(), 24, 1f, Main.myPlayer, 0f, 0f);
		}
