...
namespace TheDepths.Tiles
{
	...
	public class ChasmeRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TheDepths/Tiles/ChasmeRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TheDepths/Tiles/RelicPedestal";
