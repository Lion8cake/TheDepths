					...
					case 22:
						{
							...
							spriteBatch.Draw(treeTopTexture2, vector, (Rectangle?)new Rectangle(treeFrame * (topTextureFrameWidth3 + 2), 0, topTextureFrameWidth3, topTextureFrameHeight3), Color.White, num7 * num15, new Vector2((float)(topTextureFrameWidth3 / 2), (float)topTextureFrameHeight3), 1f, (SpriteEffects)0, 0f);
							break;
						}
					case 44:
						{
							...
							spriteBatch.Draw(treeBranchTexture3, position2, (Rectangle?)new Rectangle(0, treeFrame * 42, 40, 40), Color.White, num4 * num16, new Vector2(40f, 24f), 1f, (SpriteEffects)0, 0f);
							break;
						}
					case 66:
						{
							...
							spriteBatch.Draw(treeBranchTexture1, position, (Rectangle?)new Rectangle(42, treeFrame * 42, 40, 40), Color.White, num20 * num16, new Vector2(0f, 30f), 1f, (SpriteEffects)0, 0f);
							break;
						}
				}
			}
