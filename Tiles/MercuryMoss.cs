...
{
    public class MercuryMoss : ModTile
    {
        public override void SetStaticDefaults()
        {
			...
			TileID.Sets.NeedsGrassFramingDirt[Type] = TileID.Stone;
		...
		public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D tex = Mod.Assets.Request<Texture2D>("Tiles/MercuryMoss_Glow").Value;
