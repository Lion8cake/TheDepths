...
{
    public class PetrifiedWoodChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(70, 65, 55), CreateMapEntryName(), MapChestName);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.PetrifiedWoodChest>();
