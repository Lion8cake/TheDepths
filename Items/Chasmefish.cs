...
namespace TheDepths.Items
{
	public class Chasmefish : ModItem
	{
		...
		public override bool IsAnglerQuestAvailable() => Main.hardMode && (Worldgen.TheDepthsWorldGen.isWorldDepths || Worldgen.TheDepthsWorldGen.DrunkDepthsLeft || Worldgen.TheDepthsWorldGen.DrunkDepthsRight);
